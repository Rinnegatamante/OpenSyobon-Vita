...
//サブクラス
//(ウエイト系
#define wait(i) sceKernelDelayThread(i*1000)
...
void FillScreen();
t_graph *grap[161][8];
vita2d_texture *mgrap[51];
vita2d_texture *loadimage(string b);
t_graph *loadimage(int a, int x, int y, int r, int z);
int mirror;
